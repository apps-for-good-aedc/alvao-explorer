...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? PaginaInicialWidget() : MenuWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: TrilhosWidget.routeName,
          path: TrilhosWidget.routePath,
          builder: (context, params) => TrilhosWidget(),
        ),
        FFRoute(
          name: FaunaEFloraWidget.routeName,
          path: FaunaEFloraWidget.routePath,
          builder: (context, params) => FaunaEFloraWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: EditperfilWidget.routeName,
          path: EditperfilWidget.routePath,
