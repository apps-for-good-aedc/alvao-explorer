...
class EditperfilWidget extends StatefulWidget {
  ...
  static String routeName = 'editperfil';
  static String routePath = '/editperfil';
...
class _EditperfilWidgetState extends State<EditperfilWidget> {
  ...
  void initState() {
    ...
    _model.cityTextController ??= TextEditingController(text: currentUserEmail);
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            ...
                            if (selectedMedia != null &&
                              ...
                              safeSetState(() =>
                                  _model.isDataUploading_uploadDataH11 = true);
                              var selectedUploadedFiles = <FFUploadedFile>[];
                              ...
                              try {
                                ...
                                _model.isDataUploading_uploadDataH11 = false;
                              }
                              if (selectedUploadedFiles.length ==
                                      selectedMedia.length &&
                                  downloadUrls.length == selectedMedia.length) {
                                safeSetState(() {
                                  _model.uploadedLocalFile_uploadDataH11 =
                                      selectedUploadedFiles.first;
                                  _model.uploadedFileUrl_uploadDataH11 =
                                      downloadUrls.first;
                                });
                              } else {
                                safeSetState(() {});
